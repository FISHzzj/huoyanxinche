...
Page({
  ...
  tap1: function(){
    ...
    wx.navigateTo({
      url: '../../edit/editGps/index?rowData=' + map2json,
    })
  },
  tap2: function () {
    let that =this
    let url ='https://2.honggps.com/removeGPS'
    let data = {
      gpsid: _self.data.nowRow.id,
    }
  ...
  getGPSList: function () {
    let that = this
    let url = 'https://2.honggps.com/getGPSList'
